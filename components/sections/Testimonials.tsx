...
export default function Testimonials() {
    return (
        <section id="testimonials" aria-label="What our customers are saying" className="bg-white ">
            <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                <div className="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
                    <div className="hidden md:block mb-24 md:mb-0 sm:px-6">
                        <div className="relative">
                            <img className="rounded-xl" src="https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=500&h=600&q=80" alt="Image Description" />
                    ...
                    <div>
                        <blockquote className="relative">
                            <svg className="absolute top-0 left-0 transform -translate-x-8 -translate-y-4 h-24 w-24 text-slate-200 dark:text-slate-700" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            ...
                            <div className="relative z-10">
                                <p className="text-xs font-semibold text-slate-500 tracking-wide uppercase mb-3 dark:text-slate-200">
                                    Featured client
                                </p>

                                <p className="text-xl font-medium italic text-slate-800 md:text-2xl md:leading-normal xl:text-3xl xl:leading-normal dark:text-slate-200">
                                    To say that switching to Classway has been life-changing is an understatement. My business has tripled and I got my life back.
                                </p>
                            </div>
                            ...
                            <footer className="mt-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4 md:ml-0">
                                        <div className="text-base font-semibold text-slate-800 dark:text-slate-200">Nicole Grazioso</div>
                                        <div className="text-xs text-slate-500 dark:text-slate-400">Director Payments & Risk | Airbnb</div>
                                    </div>
                                </div>
                            </footer>

                            <div className="mt-8 lg:mt-14">
                                <a className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-slate-800 text-white hover:bg-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-800 focus:ring-offset-2 transition-all text-sm lg:p-4 dark:focus-visible:ring-offset-slate-800" href="#">
                                    Read the story
                                </a>
                            </div>
                        </blockquote>
