...
export default function Hero() {
  ...
  return (
    <div className="relative overflow-hidden bg-[#020617] py-16 sm:py-32 ">
      <svg
        ...
        className="absolute"
      >
        <g filter="url(#filter0_f_1792_6216)">
          <path
            d="M291.342 159.152C301.179 180.104 100.289 395.055 85.3418 414.152C70.3942 433.14 -71.8331 483.106 -92.6575 483.652C-113.482 484.306 11.7786 317.337 -2.658 298.458C-17.2223 279.579 -76.7739 222.372 -65.7868 200.765C-54.7997 179.267 3.32986 170.37 32.8418 170.152C62.3537 169.934 281.632 138.199 291.342 159.152Z"
            fill="#2DD4BF"
            fillOpacity="0.26"
          />
        </g>
        <defs>
          ...
          >
            ...
            <feGaussianBlur
              stdDeviation="93.5"
              result="effect1_foregroundBlur_1792_6216"
            />
          </filter>
        </defs>
      </svg>
      <div className="relative max-w-5xl mx-auto px-6 sm:px-6 lg:px-0 ">
        <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-10 md:items-center ">
          <div className='col-span-1 '>
            <h1 className="block text-3xl font-bold text-white sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
              Humanize with
              <span className="text-[#2DD4BF]"> Classway</span>
            </h1>
            <p className="mt-3 text-lg text-[#94A3B8] dark:text-slate-400">
              A rewriting assistant that gets you instant answers with no traces
              of AI
            </p>
            ...
            <div className="mt-7 grid gap-3 w-full sm:inline-flex">
              ...
              <a
                className="inline-flex justify-center border-[#0F766E] text-[#2DD4BF]  items-center gap-x-3.5 text-sm lg:text-base text-center border hover:bg-[#042F2E] shadow-sm font-medium rounded-md transition py-3 px-4 dark:border-slate-800 dark:hover:border-slate-600 dark:shadow-slate-700/[.7] dark:text-white"
                href="/extension"
              >
                View the Extension
              </a>
            ...
            <div className="mt-7">
              <div className="flex gap-1.5 items-center">
                ...
                >
                  <path
                    d="M8 1.33331C4.33333 1.33331 1.33333 4.33331 1.33333 7.99998C1.33333 11.6666 4.33333 14.6666 8 14.6666C11.6667 14.6666 14.6667 11.6666 14.6667 7.99998C14.6667 4.33331 11.6667 1.33331 8 1.33331ZM6.66667 11.3333L3.33333 7.99998L4.27333 7.05998L6.66667 9.44665L11.7267 4.38665L12.6667 5.33331L6.66667 11.3333Z"
                    fill="#0D9488"
                  />
                </svg>{' '}
                <p className="text-sm text-[#94A3B8]">3M+ questions solved</p>
              </div>
              ...
              {/* <div className="py-5">
                ...
                <div className="mt-5">
                  <svg
                    className="h-auto w-16 text-slate-800 dark:text-white"
                    width="80"
                    height="27"
                    viewBox="0 0 80 27"
                    fill="none"
          ...
          {/* <div className="relative md:ml-4 max-md:mt-4"> */}

          {/* <img
              className="w-full rounded-md"
              src={'/college-student.png'}
              // src="https://images.unsplash.com/photo-1665686377065-08ba896d16fd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=700&h=800&q=80"
              // src="https://images.unsplash.com/photo-1665686377065-08ba896d16fd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=700&h=800&q=80"
              alt="Image Description"
            />
            <div className="absolute inset-0 -z-[1] bg-gradient-to-tr from-slate-200 via-white/0 to-white/0 w-full h-full rounded-md mt-4 -mb-4 mr-4 -ml-4 lg:mt-6 lg:-mb-6 lg:mr-6 lg:-ml-6 dark:from-slate-800 dark:via-slate-900/0 dark:to-slate-900/0"></div>

            <div className="absolute bottom-0 left-0">
              <svg
                className="w-2/3 ml-auto h-auto text-slate-950 "
                width="630"
                height="451"
                viewBox="0 0 630 451"
                fill="none"
